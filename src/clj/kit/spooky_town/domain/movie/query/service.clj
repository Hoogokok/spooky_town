...
(defrecord MovieQueryServiceImpl [movie-repository movie-actor-repository movie-director-repository tx-manager]
  MovieQueryService
  (find-movie [_ params]
    (.with-read-only-transaction tx-manager [movie-repository movie-actor-repository movie-director-repository]
  ...
  (search-movies [_ params]
    (.with-read-only-transaction tx-manager [movie-repository]
      (fn [repo]
